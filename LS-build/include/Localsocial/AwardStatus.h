...
@interface RTSAwardStatus : NSObject

@property (nonatomic, retain) NSString * place_uuid;
@property (nonatomic, retain) NSString * place_name;
@property (nonatomic, retain) NSString * place_address;
@property (nonatomic, retain) NSString * place_image_url;
@property (nonatomic, retain) NSString * merchant_uuid;
